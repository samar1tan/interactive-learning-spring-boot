window.I18N = {
  ...
  ui: {
    "zh-CN": {
      ...
      tracksTitle: "按路径推进",
      nextStepEyebrow: "下一步",
      nextStepTitle: "最清晰的动作",
      nextStepCheckpoint: "检查点",
      nextStepNextModule: "下一个模块",
      pathGuideAria: "引导式学习路径",
      guidanceEyebrow: "引导路径",
      guidanceTitle: "按清晰顺序学习 Spring Boot",
      guidanceCopy:
        "每个模块都按同一个循环推进：先建立心智模型，再证明一个检查点，然后完成练习，最后请教练审查你的假设。",
      focusNow: "现在聚焦",
      pathStatusComplete: "已完成",
      pathStatusCurrent: "当前",
      pathStatusReady: "下一步",
      pathStatusOpen: "可学习",
      pathProgress: "{done}/{total}",
      guideStepModelTitle: "先建模型",
      guideStepModelCopy: "敲代码前先阅读心智模型和运行时地图。",
      guideStepCheckpointTitle: "证明理解",
      guideStepCheckpointCopy: "用自己的话完成下一个检查点。",
      guideStepPracticeTitle: "练习并审查",
      guideStepPracticeCopy: "写出练习草稿，自评，然后让教练挑战薄弱假设。",
      moduleCompleteTitle: "模块检查点已完成",
      moduleCompleteCopy: "继续做练习，或者跳到下一个未完成模块。",
      pathCompleteTitle: "路径已完成",
      pathCompleteCopy: "所有检查点都已完成。使用实验室和教练，把学习路径沉淀成可展示的架构决策。",
